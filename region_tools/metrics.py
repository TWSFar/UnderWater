...
CHIP_RESULT_FILE = "/home/twsf/data/UnderWater/val/results.json"
...
class DET_toolkit(object):
    ...
    def __call__(self):
        ...
        for img_name, det in tqdm(detecions.items()):
            pred_bbox = nms(det, score_threshold=0.05)[:, [0, 1, 2, 3, 5, 4]].astype(np.float32)
